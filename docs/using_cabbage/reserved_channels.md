...
- [USER_MUSIC_DIRECTORY](#user_music_directory)
- [USER_MOVIES_DIRECTORY](#user_movies_directory)
- [USER_PICTURES_DIRECTORY](#user_pictures_directory)
- [USER_APPLICATION_DATA_DIRECTORY](#user_application_data_directory)
- [COMMON_APPLICATION_DATA_DIRECTORY](#common_application_data_directory)
- [COMMON_DOCUMENTS_DIRECTORY](#common_documents_directory)
- [WINDOWS_SYSTEM_DIRECTORY](#windows_system_directory)
- [GLOBAL_APPLICATIONS_DIRECTORY](#global_applications_directory)
