...
The `increment` parameter quantizes all values sent to Csound channels, ensuring they snap to the specified step size. For example, with `incr: 0.1`, values will be rounded to 0.0, 0.1, 0.2, etc. before reaching Csound.
